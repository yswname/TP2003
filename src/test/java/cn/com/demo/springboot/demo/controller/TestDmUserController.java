...
import cn.com.demo.springboot.demo.constroller.DmUserController;
...
public class TestDmUserController {
    @Autowired
    private DmUserController userController;
    @Autowired
    ...
    public void testLogin()throws Exception{
        ...
        // 添加提交的数据
        String data = "userName=z&password=z";
